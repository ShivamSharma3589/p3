...
// home section 
let selfText = document.getElementById('self-text');
let selfBox = document.getElementById('self-box');
function toogleText() {
    setInterval(() => {
        if (selfBox.style.display == 'block') {
            selfText.innerHTML = 'fresher';
            selfBox.style.display = 'none';
        } else {
            selfText.innerHTML = 'web designer';
